  ...
  return (
    <AnimatePresence>
      {!isDone && (
        ...
        >
          {/* Top Archival Header */}
          <div className="flex items-center justify-between font-mono text-[11px] text-[#6B6B6B] uppercase tracking-wider border-b border-[#F2F2F2] pb-4">
          ...
          <div className="flex flex-col items-center justify-center text-center my-auto">
            ...
            <motion.div
              ...
              className="relative w-48 sm:w-64 h-[1px] bg-[#0A0A0A] mb-8"
            >
              <span className="absolute -top-1.5 -left-1 text-[9px] font-mono text-[#0A0A0A]">┌</span>
              <span className="absolute -top-1.5 -right-1 text-[9px] font-mono text-[#0A0A0A]">┐</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="font-heading font-black text-5xl sm:text-7xl lg:text-8xl text-[#0A0A0A] tracking-[-0.04em] uppercase leading-none"
            >
              FITECH
            </motion.h1>
            ...
            <motion.p
              ...
              className="font-mono text-xs sm:text-sm text-[#6B6B6B] uppercase tracking-widest mt-4"
            >
          ...
          <div className="border-t border-[#F2F2F2] pt-4 flex items-center justify-between font-mono text-xs text-[#4A4A4A]">
